    ...
    _HtmlTemplates = {
      ...
      chrome:   '<div id="epiceditor-wrapper" class="epiceditor-edit-mode">' +
                  ...
                  '<div id="epiceditor-utilbar">' +
                    (self._previewEnabled ? '<span title="' + this.settings.string.togglePreview + '" class="epiceditor-toggle-btn epiceditor-toggle-preview-btn"></span> ' : '') +
                    (self._editEnabled ? '<span title="' + this.settings.string.toggleEdit + '" class="epiceditor-toggle-btn epiceditor-toggle-edit-btn"></span> ' : '') +
